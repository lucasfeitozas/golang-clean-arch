...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x14.pb.GetOrderResponseR\x06orders\"k\n" +
	...
	"\n" +
	"ListOrders\x12\t.pb.Blank\x1a\x18.pb.GetAllOrdersResponseB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*GetAllOrdersResponse)(nil), // 2: pb.GetAllOrdersResponse
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	2, // 4: pb.OrderService.ListOrders:output_type -> pb.GetAllOrdersResponse
