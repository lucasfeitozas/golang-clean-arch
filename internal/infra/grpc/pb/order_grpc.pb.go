...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*GetAllOrdersResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*GetAllOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*GetAllOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*GetAllOrdersResponse, error) {
